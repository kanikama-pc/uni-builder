...
OS_VER="0.1"
OUTPUT_ISO="uni-os_lite_ja_0.1_amd64.iso"
VOLUME_ID="uni-os_lite_ja_0.1_amd64"
NAMESERVER="1.1.1.1"
TIMEZONE="Asia/Tokyo"
...
apt-get autopurge -y
apt-get install -y grub-efi-amd64-bin uni-desktop uni-desktop-l10n-ja /root/conf/pkgs/*.deb
apt-get autopurge -y
